...
export default function SSOPage() {
  ...
  const handleSSOLogin = async (provider: string) => {
    setLoading(true);
    setMessage(`Initiating ${provider} OAuth...`);
    
    try {
      // Step 1: Get the GitHub OAuth URL from our API
      ...
      // Step 2: Redirect to GitHub OAuth (this will navigate away from our app)
